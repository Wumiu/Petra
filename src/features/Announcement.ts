...
const ANNOUNCEMENTS: Announcement[] = [
  {
  version: "0.2.6",
  title: "✨ Petra v0.2.6 更新",
  lines: [
    "大家好，本项目新增一位成员就是我本次的更新内容和日志由我完成：",
      "· 增加了设置快捷键的功能。正常情况下按下快捷键即可唤出对话框，直接输入文字就能和桌宠对话，即使桌宠不是置顶时，也可以换出对话结束会退回原位置。",
      "· 更新完善了桌宠在待机模式下的显示规则和显示模式。该模式下不可使用对话框也不可看，填起来只有退出待机模式才有用。",
      "· 我们还优化了音乐识别的功能，播放视频时不会提示歌词无法识别这类语句。",
      "· 我们增加了对话情绪，感知AI的不同情绪和释放不一样的动画，具体我这里卖个关子，大家可以逗一逗自己的桌宠，哈哈。",
      ". 我们创建了一个交流群，更多细节可见QQ群：908632095",
      "谢谢各位一直在用 petra。有问题右键反馈给我就好。",
  ],
},
  {
    version: "0.2.5",
    title: "Petra v0.2.5 小更新",
    lines: [
      "一个不大的更新，几件小事：",
      "· 修好了歌词气泡不准的 bug：歌词密集、或者歌中间有安静段落时会跟丢，现在不会了",
      "· 新增整点报时：每到整点报一下时间。可以关掉，也能自己设定免打扰时段——都在「交互」里",
      "· 日记本改成必须配置 API 才能用：不配 API 时写出来的东西可有可无，就把那条降级路径删掉了，现在只由大模型回顾你一天做了什么再写",
      "· 反馈邮箱换上了新的授权码，反馈可以重新用了",
      "",
      "谢谢各位一直在用 petra。有问题右键反馈给我就好。",
    ],
  },
